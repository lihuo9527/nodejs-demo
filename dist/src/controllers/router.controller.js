...
var client = redis.createClient(environments_1.redisConfig.port, environments_1.redisConfig.host);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, client.getAsync(req.cookies.sessionId.split('.')[0])];
            case 1:
                id = _a.sent();
                new login_1.login().call(1);
                _a.label = 2;
            case 2:
                console.log(id);
